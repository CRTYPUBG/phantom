...
echo.
echo.
echo                                                 %lime% Developed by%u% %violet%CRTYPUBG%u%
...
echo.
echo %u%Developed by: %red%CRTYPUBG
echo %u%Github: %red%https://github.com/CRTYPUBG/phantom
echo.
echo.
...
echo.
echo %u%Developed by: %green%CRTYPUBG
echo %u%Github: %green%https://github.com/CRTYPUBG/phantom
echo.
echo.
...
:DisplayBanner
for /f "tokens=*" %%a in ('powershell -command "(Get-CimInstance Win32_Processor).Name"') do set "CPUName=%%a"
set "GPUName=NONE"
for /f "tokens=*" %%a in ('powershell -command "(Get-CimInstance Win32_VideoController).Name"') do set "GPUName=%%a"
...
echo.
echo.
echo                                %c%PHANTOM%u%%white% Tweaks%u%%c% is a batch script that optimizes your system%u%
...
echo.
echo.
echo                                    %c%PHANTOM is a tweaking script that optimizes your system%u% 
echo                                       %c%to provide the best gaming experience possible.%u%
echo.
echo.
echo.
...
echo.
echo.
echo      %green%▌ Creator:%u% %c%PHANTOM%u%
echo      %green%▌ Purpose:%u% %c%Improve System Performance%u%
echo      %green%▌ Version:%u% %c%%version% %u%
echo.
echo.
echo      %c%PHANTOM TWEAKS+ represents years of research and development in system%u%
...
echo.
echo.
echo %c%PHANTOM TWEAKS+ is a professional optimization suite designed to enhance%u% 
...
echo.
echo       %yellow%Location:%u% %c%PHANTOM Folder\PHANTOM TWEAKS+\Important - Read First.txt%u%
echo.
...
echo         %c%features added to PHANTOM TWEAKS+. The complete changelog and%u%
...
start https://github.com/CRTYPUBG/phantom/PHANTOM/releases
echo         %c%If the page doesn't open automatically, visit:%u%
echo         %lime%https://github.com/CRTYPUBG/phantom/PHANTOM/releases%u%
echo.
echo.
echo %c%══════════════════════════ PRESS ANY KEY TO CONTINUE ══════════════════════════%u%
pause >nul
...
mkdir "%TEMP%\PHANTOMBrowserExtensions" >nul 2>&1
cd /d "%TEMP%\PHANTOMBrowserExtensions"
...
if "%FIREFOX_FOUND%"=="true" (
    ...
    if exist "%ProgramFiles%\Mozilla Firefox\defaults\pref" (
        echo // Firefox Privacy Configuration - Generated by PHANTOM TWEAKS+ > "%ProgramFiles%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("toolkit.telemetry.unified", false^); >> "%ProgramFiles%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("toolkit.telemetry.enabled", false^); >> "%ProgramFiles%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("datareporting.healthreport.uploadEnabled", false^); >> "%ProgramFiles%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("datareporting.policy.dataSubmissionEnabled", false^); >> "%ProgramFiles%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("privacy.trackingprotection.enabled", true^); >> "%ProgramFiles%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
    )
    if exist "%ProgramFiles(x86)%\Mozilla Firefox\defaults\pref" (
        echo // Firefox Privacy Configuration - Generated by PHANTOM TWEAKS+ > "%ProgramFiles(x86)%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("toolkit.telemetry.unified", false^); >> "%ProgramFiles(x86)%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("toolkit.telemetry.enabled", false^); >> "%ProgramFiles(x86)%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("datareporting.healthreport.uploadEnabled", false^); >> "%ProgramFiles(x86)%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("datareporting.policy.dataSubmissionEnabled", false^); >> "%ProgramFiles(x86)%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
        echo pref^("privacy.trackingprotection.enabled", true^); >> "%ProgramFiles(x86)%\Mozilla Firefox\defaults\pref\phantom_privacy.js" 2>nul
    )
) else (
...
echo # PHANTOM Browser Privacy Optimizer - Added %date% %time% >> "%SystemRoot%\System32\drivers\etc\hosts"
...
cd /d "%TEMP%"
rmdir /s /q "PHANTOMBrowserExtensions" >nul 2>&1
...
echo %c%[2/15] Creating PHANTOM Desktop Ultimate Performance Plan...%u%
...
powercfg /changename 44444444-4444-4444-4444-444444444441 "PHANTOM Desktop Ultimate" "Maximum performance gaming plan with hidden tweaks" >nul 2>&1
...
echo %c%[2/10] Creating PHANTOM Laptop Balanced Performance Plan...%u%
...
powercfg /changename 44444444-4444-4444-4444-444444444442 "PHANTOM Laptop Performance" "Balanced performance plan optimized for gaming laptops" >nul 2>&1
...
if exist "%temp%\desktop_plan_created" (
    ...
    echo %c%• Name: PHANTOM Desktop Ultimate%u%
    ...
    echo %c%• Name: PHANTOM Laptop Performance%u%
...
echo Scanner Version: PHANTOM TWEAKS+
echo.
echo ════════════════════════════════════════════════════════════════════════════════
...
echo.
echo ════════════════════════════════════════════════════════════════════════════════
echo Report End - Generated by PHANTOM TWEAKS+ 
echo ════════════════════════════════════════════════════════════════════════════════
)
...
echo.
echo %c%                       ╔══════════════════════════════════════════════════╗ %u%
echo                        %c%║%u%           [%c%1%u%] PHANTOM Toolbox                     %c%║%u% 
...
echo.
echo.
echo                                 %c%PHANTOM Toolbox allows you to install any app or software!%u%
echo.
echo.
echo.
echo                                          %red%Press any key to start PHANTOM Toolbox!%u%
pause >nul
...
call :DisplayBanner
echo.
echo %c%Welcome to the PHANTOM Toolbox!%u%
...
:PAGE1
cls
title PHANTOM Toolbox - Page 1 of 4 (Items 1-52)
...
:PAGE2
cls
title PHANTOM Toolbox - Page 2 of 4 (Items 53-104)
...
:PAGE3
cls
title PHANTOM Toolbox - Page 3 of 4 (Items 105-156)
...
:PAGE4
cls
title PHANTOM Toolbox - Page 4 of 4 (Items 157-208)
...
:Destruct
title Thanks for using PHANTOM TWEAKS+!
cls
echo.            
echo %u%Developed by: %c%CRTYPUBG   
echo %u%Github: %c%https://github.com/CRTYPUBG/phantom
timeout /t 5 >nul
endlocal
exit
